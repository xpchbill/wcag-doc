...
> The mandate of this audit covers the `native desktop browser` experience limited to audience view `(including responsive)`, of the test pages identified within the Tested Product section below, `exclusive of PDF file content`, as observed in May/June 2022.
...
## Issue status legend {background-color="black" background-image="/images/Picture1.png" background-opacity="0.3"}
